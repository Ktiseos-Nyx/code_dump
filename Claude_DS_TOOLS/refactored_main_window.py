...
from ..correct_types import DownField, EmptyField, ExtensionType as Ext, UpField
from ..logger import debug_monitor, info_monitor as nfo
from ..metadata_parser import parse_metadata
from .components import ImageLabel, LeftPanelWidget
from .dialogs import SettingsDialog, AboutDialog
from .layout_manager import LayoutManager
from .menu_manager import MenuManager
from .metadata_display import MetadataDisplayManager
...
class MainWindow(Qw.QMainWindow):
    ...
    def load_files(self, folder_path: str, file_to_select_after_load: Optional[str] = None) -> None:
        ...
        self._start_file_loading(folder_path, file_to_select_after_load)
    ...
    def _start_file_loading(self, folder_path: str, file_to_select: Optional[str]) -> None:
